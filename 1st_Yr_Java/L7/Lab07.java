 ...
 * Description: Program takes in a size for an array from the user.
 * Then the user enters in the numbers for the array. The program displays
 * the array for the user then asks to enter a new size for the array. Then
 * the user enters in the new numbers for the array. The program asks the user
 * for a value to count. The program tells the user how many times the number
 * appears in the array and displays the max, min, and reversed form of the array.
 * Date: 10/31/15
 *
 ---------------------------------------------------------------------------- */
